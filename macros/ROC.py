...
SIGS = ['Hto4b_mH-125', 'Hto4b_mH-125_mAHi', 'Hto4b_wH-70', 'Hto4b_wH-70_mHIn']
BKGS = ['QCD', 'QCD_mHIn', 'QCD_2b', 'QCD_3b', 'QCD_4b']
VARS = ['PN_Xto4b', ## score_label_H_aa_bbbb
...
###################
    ...
    for ch in in_chains:
        ...
        for jEvt in range(ch.GetEntries()):
            ...
            if ch.fj_pt >= 1000: continue
            if ch.fj_mass <= 50: continue
            if ch.pfMassDecorrelatedParticleNetDiscriminatorsJetTags_XbbvsQCD <= 0.1: continue
            ...
            is_mH125  = (ch.label_H_aa_bbbb and iCh == 1)
            ...
            is_QCD_mHIn   = is_QCD   and ch.fj_mass > 85 and ch.fj_mass < 135
            is_wH70_mHIn  = is_wH70  and ch.fj_mass > 85 and ch.fj_mass < 135
            is_mH125_mAHi = is_mH125 and ch.fj_gen_H_aa_bbbb_mass_a > 22.5

            train = (((ch.event_no % 101) % 2) == 0)

            if not (is_QCD or is_mH125 or is_wH70): continue
            ...
            for VAR in VARS:
                for SIG in SIGS:
                    if (is_mH125 and SIG == 'Hto4b_mH-125') or (is_mH125_mAHi and SIG == 'Hto4b_mH-125_mAHi') or \
                       (is_wH70 and SIG == 'Hto4b_wH-70') or (is_wH70_mHIn and SIG == 'Hto4b_wH-70_mHIn'):
                        h_1D[VAR][SIG]['tr' if train else 'te'].Fill( VALS[VAR], WGT )
                for BKG in BKGS:
                    if (is_QCD and BKG == 'QCD') or (is_QCD_mHIn and BKG == 'QCD_mHIn') or \
                       (is_QCD_2b and BKG == 'QCD_2b') or (is_QCD_3b and BKG == 'QCD_3b') or (is_QCD_4b and BKG == 'QCD_4b'):
    ...
    colors = {}
    colors['Hto4b_mH-125']      = R.kGreen+3
    colors['Hto4b_mH-125_mAHi'] = R.kGreen
    colors['Hto4b_wH-70']       = R.kRed
    colors['Hto4b_wH-70_mHIn']  = R.kMagenta
    colors['QCD']               = R.kBlue
